    ...
    <section class="hero">
        <div class="container hero-grid">
            <div>
                ...
                <div class="cta-row">
                    <a class="btn btn-brand" href="listen.php">Listen now</a>
                    <a class="btn btn-dark" href="shop.php">Buy album</a>
    ...
    <section class="section">
        <div class="container split-2">
            <article class="card">
                ...
                <div class="cta-row">
                    <a class="btn" href="album.php">View album page</a>
    ...
    <section class="section">
        <div class="container split-2">
            <article class="card">
                ...
                <div class="cta-row"><a class="btn" href="videos.php">View all videos</a></div>
            </article>
            <article class="card">
        ...
        <div class="container split-2">
            <article class="card">
                ...
                <form action="<?php echo htmlspecialchars($site['mailerlite_action']); ?>" method="post" aria-label="MailerLite signup form">
                    ...
                    <p>By subscribing, you agree to our <a href="privacy.php">Privacy Policy</a>.</p>
                </form>
            </article>
            <article class="card">
                ...
                <?php endforeach; ?>
                <div class="cta-row">
                    <a class="btn" href="book.php">Book the artist</a>
                    <a class="btn" href="epk.php">View EPK</a>
                </div>
            </article>
        </div>
    </section>
